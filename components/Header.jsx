      ...
      <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-full px-4 sm:px-6 md:px-8 py-3 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
              ...
              appearance={{
                elements: {
                  ...
                  userButtonPopoverCard:
                    "shadow-xl backdrop-blur-md bg-slate-900/90 border font-bold border-white/20",
                  userPreviewMainIdentifier: "font-semibold text-#e4dcdc-400",
                },
              }}
              afterSignOutUrl="/"
            />
          ...
          <Unauthenticated>
            ...
            <SignUpButton>
              <Button variant="primary" size="sm" className="whitespace-nowrap animate-bounce">
                Get Started
              </Button>
            </SignUpButton>
          </Unauthenticated>
